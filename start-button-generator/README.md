...
![Producer console — empty state](screenshots/01-console-empty.png)

**A filled-in episode** ready to generate.

![Producer console — filled in](screenshots/02-console-filled.png)
...
![Generated episode rundown](screenshots/03-episode-rundown.png)
